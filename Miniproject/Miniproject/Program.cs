...
namespace Program
{
    ...
    {
        private static string connectionString = "data source=ICS-LT-DD4W8C3\\SQLEXPRESS; initial catalog=RaiwayReservation; User ID=sa; Password=Absci256@";
        ...
        private static void AdminLogin()
        {
            ...
            if (adminUsername == "abhi" && adminPassword == "abhi123") // Simplistic approach for example
            {
